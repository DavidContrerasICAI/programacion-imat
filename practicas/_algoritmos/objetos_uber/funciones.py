...
def borrar_en_ciudad(matriz:list[list], objeto):
    matriz[objeto.x][objeto.y] = None

def posicionar_en_ciudad(matriz:list[list], objeto):
    matriz[objeto.x][objeto.y] = objeto

def init_ciudad(matriz:list[list]):
...
def print_ciudad(matriz:list[list]):
    print(f" " * 4, end="")
