...
def limpiar_datos_objetos(ordenador:str) -> obj.Ordenador:
    """
    Convierte un string sucio a un objeto procesado y limpio.

    Return:
        ordenador (Ordenador): un objeto de la clase Ordenador con todos los valores 
